...
export default async function Dashboard() {
  ...
  if (!userId) {
    return (
      <div className="p-4">
        <h2 className="text-2xl font-bold text-white">Please sign in to view your dashboard.</h2>
      </div>
    );
  }
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-3">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:col-span-2">
          {info.map((item, index) => {
            ...
            return (
              <Card key={index} className="bg-[#0F172A] border border-zinc-800 hover:border-emerald-500/40 transition-all rounded-xl">
          ...
          <div className="p-3 pt-10 h-full">
            <div className="w-full h-full p-3 flex flex-col gap-3">
              ...
              <div className="flex flex-col items-center gap-2 mt-2">
                ...
                <div className="text-sm text-zinc-300 font-medium pt-1">
